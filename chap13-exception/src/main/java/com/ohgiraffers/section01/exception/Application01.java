...
public class Application01 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        * 오류가 발생할 수 있다.
        * 컴푸터 프로그램이 동작하는 도중에 예상하지 못한 사태가 발생되며
        * 실행 중인 프로그램이 영향을 받는 것을 오류(Error)와 예외(Exception) 두 가지로 구분할 수 있다./
        *
        * 오류(Error)
        * 시스템 상에서 프로그램에 심각한 문제를 발생ㅅ\하여 실행중인 프로그램이 종료되는 것을 말한다.
        ...
        * */
        ...
        exceptionTest.checkedEnoughMoney(10000000, 100);
        exceptionTest.checkedEnoughMoney(5000, 10000);
